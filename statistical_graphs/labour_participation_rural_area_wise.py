...
def year_estimated_labour_participation_rate_rural():
    
    df_rural,year = fetch_dataframe()
    
    #print(year)
    
    data = df_rural.groupby(['Year'])[['Estimated Labour Participation Rate']].mean() #Grouped by month
    ...
    fig.update_layout(title = 'Yearly Estimated Average Employed in Rural Areas - 2016 - 2021')
...
def year_monthly_estimated_average_labour_participation_rate_rural():
    ...
    average_labour_participation_rate = df_rural.groupby(['Year', 'Month'])['Estimated Labour Participation Rate'].mean().reset_index()
    
    fig = px.bar(average_labour_participation_rate,x='Month',y='Estimated Labour Participation Rate',animation_frame='Year',
                title='Estimated Labour Participation Rate in rural areas from 2016 - 2021',text="Month",width=550, height=600,
...
def estimated_labour_participation_rate_in_rural_area_weekly_basis():
    
    df_rural,year = fetch_dataframe()
    
    fig=px.line(df_rural, x='Date', y='Estimated Labour Participation Rate', title='Estimated Labour Participation Rate in rural areas every week from 2016 to 2021',
